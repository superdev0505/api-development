...
<table name="tablita" id="tablita" class="table">
    ...
    @foreach($registros as $registro)
        @php
            $registro['rut_empresa_raw'] = explode('-', $registro['rut_empresa'])[0];
            $registro['rut_empresa_raw'] = str_replace('.','', $registro['rut_empresa_raw']);
            $registro['rut_empresa_raw'] = intval($registro['rut_empresa_raw']);
        @endphp
        <tr>
            <td>{{ $registro['rut_empresa_raw'] }}</td>
            ...
            <td>{{ ($registro['primera_compra_monto']) ? $registro['primera_compra_monto'] : 0 }}</td>
